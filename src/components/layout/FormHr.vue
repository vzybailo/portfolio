<template>
    <form action="" class="form-hr">
        ...
        <div class="form-hr__text"><input v-model="inputText" class="form-hr__input" type="text" placeholder="[HR Name]"></div>
        <div class="form-hr__text">Company <input class="form-hr__input" type="text" placeholder="[Company]"></div>
        <div class="form-hr__text">Contact: <input class="form-hr__input" type="text" placeholder="[Email/phone]"></div>
